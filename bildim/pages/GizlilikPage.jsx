...
export default function GizlilikPage() {
  return (
    <div className="bd-metin-sayfa">
      ...
      <h2>Kısaca</h2>
      <p>
        Quiz Tactics, oyunu oynayabilmen için gereken en az veriyi toplar:{" "}
      ...
      <h2>Çocuklar</h2>
      <p>
        Quiz Tactics 13 yaş altındaki çocuklara yönelik değildir ve bilerek 13 yaş altından veri
        toplamayız.
      </p>
