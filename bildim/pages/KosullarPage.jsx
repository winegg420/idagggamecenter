...
export default function KosullarPage() {
  return (
    <div className="bd-metin-sayfa">
      ...
      <h2>Kısaca</h2>
      <p>
        <b>Quiz Tactics</b> bilgi yarışması ücretsiz olarak sunulur. Oyun hem kendi
        adresinde hem de Quiz Tactics oyun portalı içinde oynanabilir; bu koşullar
      ...
      <p>
        ...
        (bundan sonra "sen") arasındaki sözleşmedir. Kapsam, Quiz Tactics sitesi ve
